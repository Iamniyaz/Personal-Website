  ...
  return(
   ...
   <section className="pb-16 lg:py-24">
    <div className="container">
      ...
      See how I transformed concept into engaging digital experiences.</p>
      <div className="mt-10 md:mt-20 flex flex-col gap-20 mt-10">
        {portfolioProjects.map((project)=>(
          ...
          pt-8 px-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none">
            ...
            <a href={project.link}>
                  <button className="bg-white text-gray-500 h-12 w-full md:w-auto px-6 rounded-xl  font-semibold inline-flex items-center justify-center gap-2 mt-8">
